...
./create_cgc -query "nomad*runtime*free_count" -title "Nomad runtime free_count" -tags "creator:api, role:server, service:nomad, data-type:gauge, group:secondary"
...
./create_cgc -query "nomad*runtime*malloc_count" -title "Nomad runtime malloc_count" -tags "creator:api, role:server, service:nomad, data-type:gauge, group:secondary"
...
./create_cgc -query "nomad*runtime*total_gc_pause_ns" -title "Nomad runtime total_gc_pause_ns" -tags "creator:api, role:server, service:nomad, data-type:gauge, group:secondary"
